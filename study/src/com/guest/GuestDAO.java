...
public class GuestDAO {
	...
	public int insertData(GuestDTO dto) {
		...
		try {
			...
			sql = "insert into guest (num,name,email,homepage,content,created,ipAddr) values (?,?,?,?,?,sysdate,?)";
	...
	public List<GuestDTO> getListData(int start, int end){
		...
		try {
			...
			sql += "(select num,name,email,homepage,created,ipAddr,content from guest order by num desc) data) ";
